...
public abstract class Search {
	...
	public String runSearch(SearchState initState, String strategy) {
		List<Integer> totalIterations = new ArrayList<Integer>();
		...
		while (!open.isEmpty()) {
		    ...
		    totalIterations.add(iterationCount);
			...
			if (currentNode.goalPredicate(this))
				return reportSuccess(totalIterations); // success
	...
	private String reportSuccess(List<Integer> totalIterations) {
	    ...
	    System.out.println("Total number of Iterations: " + totalIterations.size());
